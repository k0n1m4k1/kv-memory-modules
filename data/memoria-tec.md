# Memoria del agente: memoria-tec

Dossier de contexto del dominio. Memorias relacionadas: [[memoria-ops]].
El material narrativo procede de Wikipedia en español (CC BY-SA 4.0: Inteligencia artificial, Computadora); las notas internas son la fuente de verdad del equipo.
...
> **Nota interna 1 (EXP--TEC-3850)**: expediente asignado a Olalla, presupuesto 58900 euros, estado "en curso", fecha límite el 6 de marzo de 2027.
== Denominación ==
...
> **Nota interna 2 (EXP--TEC-9831)**: expediente asignado a Quima, presupuesto 74700 euros, estado "bloqueado", fecha límite el 14 de abril de 2027.

> **Nota interna 3 (EXP--TEC-8417)**: expediente asignado a Héctor, presupuesto 50500 euros, estado "en curso", fecha límite el 15 de abril de 2027.
== Tipos ==
...
Los sistemas de IA generativa notables incluyen ChatGPT (y su variante Microsoft Copilot), un bot conversacional creado por OpenAI usando sus modelos de lenguaje de gran escala de última generación, como GPT-5 y sus iteraciones de razonamiento avanzado (o1); Gemini (anteriormente llamado Bard), un bot conversacional creado por Google usando la familia de modelos multimodales nativos Gemini 2.0 y versiones superiores; y Claude, un bot conversacional creado por Anthropic usando los modelos Claude 3.5 y 4, destacados por su alta fidelidad en tareas de codificación y análisis de contexto extenso.​Otros modelos generativos de IA incluyen sistemas de arte de inteligencia artificial como Stable Diffusion, Midjourney y DALL-E, que permiten crear imágenes. Actualmente la IA generativa puede crear texto, código, imágenes, vídeo, música, voces y efectos de sonido.
...
> **Nota interna 4 (EXP--TEC-4390)**: expediente asignado a Ramiro, presupuesto 40200 euros, estado "en curso", fecha límite el 2 de marzo de 2027.
...
> **Nota interna 5 (EXP--TEC-1370)**: expediente asignado a Bruno, presupuesto 34200 euros, estado "en curso", fecha límite el 12 de junio de 2027.
...
En 1955 fue ideada la expresión «inteligencia artificial» por John McCarthy, Marvin Minsky y Claude Shannon en el documento​ con la propuesta para la Conferencia de Dartmouth de 1956. El término fue introducido como una manera de separar la disciplina del campo de los autómatas y señalar su objetivo prioritario de la creación de máquinas que realizasen tareas similares a la inteligencia humana. El término además parecía más apropiado para obtener subvenciones que el original de «estudios de autómatas» , como explicó uno de sus autores, John McCarthy, en el debate Lighthill de 1973​  En la conferencia se hicieron previsiones triunfalistas a diez años que jamás se cumplieron, lo que provocó el abandono casi total de las investigaciones durante quince años.
...
En 1966 y 1972 Artificial Intelligence Center desarrollo el Robot Shakey, considerado el primer robot inteligente de la historia. El robot incluía visión artificial, y tenía la capacidad de percibir y razonar sobre su entorno.
...
> **Nota interna 6 (EXP--TEC-5115)**: expediente asignado a Héctor, presupuesto 79300 euros, estado "bloqueado", fecha límite el 1 de febrero de 2027.

> **Nota interna 7 (EXP--TEC-7603)**: expediente asignado a Aitana, presupuesto 6600 euros, estado "en curso", fecha límite el 13 de febrero de 2027.

> **Nota interna 8 (EXP--TEC-1495)**: expediente asignado a Héctor, presupuesto 41700 euros, estado "en revisión", fecha límite el 9 de enero de 2027.

> **Nota interna 9 (EXP--TEC-5033)**: expediente asignado a Maider, presupuesto 14000 euros, estado "en revisión", fecha límite el 15 de febrero de 2027.
== Tendencias ==
...
== Implicaciones sociales, éticas y filosófica ==
...
> **Nota interna 10 (EXP--TEC-5410)**: expediente asignado a Inés, presupuesto 36300 euros, estado "aprobado", fecha límite el 25 de marzo de 2027.
Primera Ley
...
Adicionalmente a los dilemas éticos y sociales que genera el desarrollo de la inteligencia artificial, en los últimos años ha surgido un debate en torno al impacto ecológico derivado del uso de esta tecnología. El entrenamiento y la operación de modelos masivos de IA generativa exigen un consumo de energía eléctrica y agua sumamente elevado, lo que incrementa de forma directa las emisiones de carbono a la atmósfera y presiona las redes eléctricas actuales ​(Massachusetts Institute of Technology, 2025).
Los costos ecológicos de estas tecnologías son medibles incluso a nivel de consumo del usuario individual, el observatorio del instituto para el futuro de la educación, menciona que una sola sesión de consultas de entre 20 y 50 preguntas en sistemas de lenguaje como ChatGPT llega a consumir cerca de medio litro de agua.​  Ante esta escala la IA provocará una alta huella hídrica y energética, en el ámbito corporativo y científico se ha comenzado a debatir la urgencia de adoptar políticas estrictas para reducir los daños que puedan suceder, algunas propuestas como el empleo de energía 100 % libre de carbono y el compromiso del balance hídrico positivo, tienen el propósito de transitar hacia un nuevo modelo operativo y de diseño de software denominado "IA verde".


> **Nota interna 11 (EXP--TEC-6367)**: expediente asignado a Jorge, presupuesto 19200 euros, estado "bloqueado", fecha límite el 11 de febrero de 2027.
== Regulación ==
...
=== Planificación ===
Otro objetivo de la inteligencia artificial consiste en poder establecer metas y finalmente alcanzarlas.​ Para ello necesitan una forma de visualizar el futuro, una representación del estado del mundo y poder hacer predicciones sobre cómo sus acciones lo cambiarán, con tal de poder tomar decisiones que maximicen la utilidad (o el «valor») de las opciones disponibles.​
