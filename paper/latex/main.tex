...
\title{\textbf{Precompiled KV Memory Modules: Relocatable, Composable Agent Memory for LLM Inference Runtimes}\thanks{Code, data, and raw experimental outputs: \url{https://github.com/k0n1m4k1/kv-memory-modules}.}}
